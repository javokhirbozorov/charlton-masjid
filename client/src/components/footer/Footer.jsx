...
<footer className="bg-black dark:bg-gray-900">
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 md:flex md:items-center md:justify-around">
        <div className='ml-10'>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400 text-center">Company</h2>
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400 text-center">Help center</h2>
            <ul className="text-gray-500 dark:text-gray-400 text-center">
                <li className="mb-4">
        ...
        <div className='mr-10'>
            <h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400 text-center">Download</h2>
            <ul className="text-gray-500 dark:text-gray-400 text-center">
                <li className="mb-4">
    ...
    <div className="bg-black py-6 px-4 bg-gray-900 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Muslim™</a>. Web Development.
        </span>
